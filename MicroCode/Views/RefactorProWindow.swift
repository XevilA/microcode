    ...
    private func generateFormalHTML(report: RefactorReport) -> String {
        ...
        <body>
            ...
            <div class="section">
                ...
                <p>This report details the automated refactoring process performed by MicroCode AI. The source code has been analyzed, optimized, and transformed to meet modern standards and specific user requirements.</p>
            </div>
            ...
            <div class="footer">
                Generated by MicroCode AI • \(report.timestamp.formatted(date: .long, time: .shortened))
            </div>
        </body>
        </html>
        """
