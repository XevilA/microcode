...
public func fetchGhostText(endpoint: String, model: String, prefix: String, suffix: String)async throws  -> String {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_microcode_core_fn_func_fetch_ghost_text(FfiConverterString.lower(endpoint),FfiConverterString.lower(model),FfiConverterString.lower(prefix),FfiConverterString.lower(suffix)
                )
            },
            pollFunc: ffi_microcode_core_rust_future_poll_rust_buffer,
            completeFunc: ffi_microcode_core_rust_future_complete_rust_buffer,
            freeFunc: ffi_microcode_core_rust_future_free_rust_buffer,
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_microcode_core_checksum_func_fetch_ghost_text() != 36448) {
