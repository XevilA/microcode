...
class CodeAnalysisViewModel: ObservableObject {
    ...
    private func generateReportContent(result: AnalysisResult, includeCode: Bool, includeRefactored: Bool, companyName: String, projectName: String) -> String {
        ...
        ------------------------------------------------------------
        Prepared by:    CodeTunner AI Analysis System
        Date:           \(formattedDate)
        ...
        This report was automatically generated by CodeTunner AI Analysis
    ...
    private func generateHTML(content: String, result: AnalysisResult, companyName: String, projectName: String) -> String {
        ...
        <body>
            ...
            <table class="info-table">
                <tr><td>Prepared by</td><td>CodeTunner AI Analysis System</td></tr>
            ...
            <div class="footer">
                <p>This report was automatically generated by CodeTunner AI Analysis System using \(result.provider.rawValue).</p>
